...
<section class="container">
  <div class="page-header">
    <h1 color="white"><b>Meet The Team<br></b></h1>
  </div>
  <div class="row active-with-click">
    <div class="col-md-4 col-sm-6 col-xs-12">
      <article class="material-card Red">
        <h2>
          <span>Sanskar Khandelwal</span>
          <strong>
        ...
        <div class="mc-content">
          <div class="img-container">
            <img class="img-responsive" src="images/sanskar.jpg">
          </div>
          <div class="mc-description">
             <p>B.E.(IT) 3rd year</p>
        <p>khandelwalsa@rknec.edu</p>
          </div>
        </div>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
      <article class="material-card Pink">
        ...
        <div class="mc-content">
          <div class="img-container">
            <img class="img-responsive" src="images/pp.jfif">
          </div>
          <div class="mc-description">
            <p>B.E.(IT) 3rd year</p>
        <p>singhavihr@rknec.edu</p>
		</div>
        </div>
        <a class="mc-btn-action">
          <i class="fa fa-bars"></i>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
      <article class="material-card Purple">
        ...
        <div class="mc-content">
          <div class="img-container">
            <img class="img-responsive" src="images/varunesh.jpeg">
          </div>
          <div class="mc-description">
         <p>B.E(IT) 3rd year</p>
        <p>agrawalvs@rknec.edu</p>
		</div>
        </div>
        <a class="mc-btn-action">
          <i class="fa fa-bars"></i>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
      <article class="material-card Deep-Purple">
        ...
        <div class="mc-content">
          <div class="img-container">
            <img class="img-responsive" src="images/dishant.jpeg">
          </div>
          <div class="mc-description">
            <p>B.E(IT) 3rd year</p>
        <p>chandakds@rknec.edu</p>
          </div>
        </div>
        <a class="mc-btn-action">
          <i class="fa fa-bars"></i>
